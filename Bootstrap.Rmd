...
The same methodology can be used to bootstap the distribution of other complex regression model tests statistics and diagnostics (i.e. R<sup>2</sup>, AIC, BIC, etc.)
